            ...
            <div class="col-lg-7">
                <div class="products-viwe mt-30">
                    <div class="singel-slied">
                        <img src="assets/images/product/crest670x600.jpg" alt="Products">
                    </div>
                    <div class="singel-slied">
                        <img src="assets/images/product/crest670x600.jpg" alt="Products">
                    </div>
            ...
            <div class="col-lg-5">
                <div class="products-details pt-30">
                    ...
                    <div class="Desciption pt-20">
                        <h4>Plan details:</h4>
                        <p>
                            &#x25cf; Basic and minimum availed plan.<br><br>
                            &#x25cf; Ideally suitable for family.<br><br>
                            &#x25cf; 4 number 2 adults and 2 kids .<br><br>
                            &#x25cf; Tank capacity of 7 liters purification.<br><br>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                            <div class="Product-tab-cont">
                                <p>Plan - 7 liters Capacity Plan</p>
                                <!--<h6>Plan details:</h6>-->
                                <ul>
                                    ...
                                    <li> To Alkaline Ionization Processor</li>
                                    <li> Active Copper Technology</li>
                                    <li> Wall Mounting Appliance</li>
                                    <li> Tank Capacity: 7 liters</li>
